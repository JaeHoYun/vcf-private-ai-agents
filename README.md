...
| | 06 | [데이터 소스 온보딩과 보호 문서](docs/06-data-onboarding.md) | 파생 사본이 문제라는 재정의, 원칙 여섯, 범위 결정 절차와 등급별 처리, 여섯 개 존 밑그림, 인입 패턴 다섯과 관리형 대 커스텀 판정, 승인 체인과 운영 루프, 규제 관점, 국내 저장소의 장벽(문서보안이 먼저, 언어가 다음) |
