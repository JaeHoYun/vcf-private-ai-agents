...
| 책임 영역 | 왜 PAIS 밖인가 | 방향 |
|-----------|----------------|------|
| 최종 사용자 신원·인가(사용자별 접근 권한·테넌트 격리) | 에이전트 엔드포인트는 호출하는 서비스만 알 뿐, 최종 사용자가 누구인지 모른다 | 앱이 사용자 신원을 주입·강제 · [03 §3.9](03-agent-builder.md) · [⑤](https://github.com/JaeHoYun/vcf-private-ai-security-governance) |
