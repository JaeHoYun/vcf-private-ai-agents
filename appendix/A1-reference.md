...
| v0.11 | 2026-06 | 재작성 — docs/08을 산업별 분류('산업 유스케이스')에서 '어디에 쓰나'로 전면 개편. 공개 리서치(MIT GenAI Divide·Gartner 취소율/agent washing) 근거로 다섯 실패 모드+선별 기준 프레임 도입, 사례를 산업 중립 2종(사내 지식 응대·운영 알림 1차 진단)으로 교체. README 문서표·빠른시작, 07·A1 내비 링크 동기화 |
